        ...
        blocks: [
            {
                ...
                imageURL: '/static/accordion.png',
            },
            {
                title: 'Featured Content',
                description: 'A list of featured content',
                imageURL: '/static/featured-content.png',
            },
            {
                title: 'Featured Content Grid',
                description: 'A grid of featured content',
                imageURL: '/static/featured-content-grid.png',
            },
            {
                title: 'Featured Link List',
                description: 'A list of featured links',
                imageURL: '/static/featured-link-list.png',
            },
            {
                title: 'Featured Quote',
                description: 'A featured quote',
                imageURL: '/static/featured-quote.png',
            },
            {
                title: 'Featured Quotes',
                description: 'A list of featured quotes',
                imageURL: '/static/featured-quotes.png',
            },
            {
                title: 'Shared Content Reference',
                description: 'A list of shared content references',
                imageURL: '/static/shared-content-reference.png',
            },
            {
                title: 'Search Box',
                description: 'A search box',
                imageURL: '/static/search-box.png',
            },
            {
                title: 'Tabbed Content',
                description: 'A list of tabbed content',
                imageURL: '/static/tabbed-content.png',
            },
            {
                title: 'Table',
                description: 'A table',
                imageURL: '/static/table.png',
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                imageURL: '/static/images-with-actions.png',
            },
            {
                title: 'YouTube Video',
                description: 'A YouTube video',
                imageURL: '/static/you-tube-video.png',
            },
            {
                title: 'YouTube Video Selection',
                description: 'A list of YouTube videos with a selection',
                imageURL: '/static/you-tube-video-selection.png',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                imageURL: '/static/document-group-block.png',
            },
            {
                title: 'Document Group List',
                description: 'A list of document groups',
                imageURL: '/static/document-group-list.png',
            },
            {
                title: 'Document List',
                description: 'A list of documents',
                imageURL: '/static/document-list.png',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                imageURL: '/static/dealer-list.png',
            },
            {
                title: 'Dealer Map',
                description: 'A map of dealers',
                imageURL: '/static/dealer-map.png',
            },
            {
                title: 'Dealer Selection',
                description: 'A list of dealers with a selection',
                imageURL: '/static/dealer-selection.png',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                imageURL: '/static/contact-person-list.png',
            },
            {
                title: 'Contact Person Selection',
                description: 'A list of contact persons with a selection',
                imageURL: '/static/contact-person-selection.png',
            },
            {
                title: 'Vacancy List',
                description: 'A list of vacancies',
                imageURL: '/static/vacancy-list.png',
            },
        ],
    },
];
